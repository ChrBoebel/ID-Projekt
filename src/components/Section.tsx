  ...
  return (
    <section id={id} className={`mb-16 sm:mb-24 lg:mb-32 scroll-mt-20 sm:scroll-mt-32 relative ${className}`}>
      <div className="mb-8 sm:mb-12 lg:mb-16">
        <h2 className="print-title text-3xl sm:text-4xl lg:text-5xl font-light font-heading text-[#003E77] mb-4 sm:mb-6 tracking-tight leading-tight">
          {title}
        </h2>
        {subtitle && (
          <p className="print-subtitle text-gray-500 text-lg sm:text-xl lg:text-2xl font-light tracking-wide max-w-3xl leading-relaxed">{subtitle}</p>
        )}
      </div>
...
export function SubSection({ id, title, children }: SubSectionProps) {
  return (
    <div id={id} className="mb-10 sm:mb-14 scroll-mt-20 sm:scroll-mt-24">
