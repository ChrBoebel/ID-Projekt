...
export default function FeatureCard({ icon, title, description }: FeatureCardProps) {
  return (
    <div className="feature-card group bg-white rounded-lg sm:rounded-xl border border-slate-100 p-4 sm:p-6 lg:p-8 shadow-sm hover:shadow-xl hover:shadow-blue-900/5 transition-all duration-300 relative overflow-hidden">
      ...
      <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 rounded-lg bg-slate-50 border border-slate-100 flex items-center justify-center mb-3 sm:mb-4 lg:mb-6 text-[#003E77] group-hover:bg-[#003E77] group-hover:text-white group-hover:[&_svg]:text-white transition-colors relative z-10 shadow-sm">
        {icon}
      </div>
