  ...
  return (
    <div className="flex items-end gap-2 p-3 border-t border-slate-200 bg-white">
      ...
      <button
        ...
        className="shrink-0 w-9 h-9 flex items-center justify-center rounded-xl bg-[#003E77] text-white hover:bg-[#004A99] disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
      >
